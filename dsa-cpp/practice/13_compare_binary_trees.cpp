// Practice: recursive binary tree comparison.
// Teaches base cases, recursion, and std::unique_ptr tree ownership.
#include <cassert>
#include <iostream>
#include <memory>
...
bool compare(const BinaryNode<int>* left, const BinaryNode<int>* right) {
    // TODO: implement
    // Hint: handle null cases first, compare values, then recurse into both subtrees.
    (void)left;
    (void)right;
    return false;
}
