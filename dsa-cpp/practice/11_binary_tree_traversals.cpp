// Practice: depth-first binary tree traversals.
// Teaches templates, recursion, and std::unique_ptr-based tree structure.
#include <cassert>
#include <iostream>
#include <memory>
#include <vector>
...
void pre_order_impl(const BinaryNode<T>* node, std::vector<T>& out) {
    // TODO: implement
    // Hint: visit node, then left subtree, then right subtree.
    (void)node;
    (void)out;
}
...
void post_order_impl(const BinaryNode<T>* node, std::vector<T>& out) {
    // TODO: implement
    // Hint: visit left subtree, then right subtree, then node.
    (void)node;
    (void)out;
}
...
std::vector<T> pre_order(const BinaryNode<T>* node) {
    // TODO: implement
    // Hint: create an output vector, fill it via pre_order_impl, and return it.
    (void)node;
    return {};
}
...
std::vector<T> in_order(const BinaryNode<T>* node) {
    // TODO: implement
    // Hint: create an output vector, fill it via in_order_impl, and return it.
    (void)node;
    return {};
}
...
std::vector<T> post_order(const BinaryNode<T>* node) {
    // TODO: implement
    // Hint: create an output vector, fill it via post_order_impl, and return it.
    (void)node;
    return {};
}
