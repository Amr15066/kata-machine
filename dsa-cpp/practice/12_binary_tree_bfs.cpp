// Practice: breadth-first search on a binary tree.
// Teaches queue-based traversal, std::unique_ptr trees, and iterative search.
#include <cassert>
#include <iostream>
#include <memory>
...
bool bfs(BinaryNode<int>* root, int needle) {
    // TODO: implement
    // Hint: push the root into the queue, then process nodes level by level until you find needle.
    (void)root;
    (void)needle;
    return false;
}
